 ...
 *
 * it's final to use the class directly without make instance
 */
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for (int i = 0; i < earthquakesArray.length(); i++) {
                JSONObject earthQuakeJsonObj = earthquakesArray.getJSONObject(i);
                JSONObject properties = earthQuakeJsonObj.getJSONObject("properties");
